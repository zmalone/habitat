...
impl fmt::Display for Error {
  fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
    let msg = match *self {
      ...
      Error::EffectiveGroupnameNotFound => String::from("Could not determine groupname of process"),
      Error::EffectiveUsernameNotFound => String::from("Could not determine username of process"),
      Error::FileEntryNotFound(ref e, ref f) => format!("Could not find file entry {} in {}", e, f),
      ...
      Error::HomeDirectoryNotFound => String::from("Could not determine user's home directory"),
